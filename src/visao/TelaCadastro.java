...
public class TelaCadastro extends javax.swing.JFrame {
    ...
    // Objeto de acesso a dados para usuários
    UsuarioDAO dUsuario = new UsuarioDAO();
    // Objeto de modelo de tabela para usuários
    Usuario mUsuario = new Usuario();
    // Flag para controle de operações
    private int flag;
    // Imagem geral para armazenar a imagem do usuário
    BufferedImage imagemGeral;
    // Tabela de usuários
    tableUsuario t = new tableUsuario();

    /**
     * Cria a nova form TelaCadastro.
     */
    public TelaCadastro() {
        ...
        // Atualização da tabela com dados do banco
        atualizaTabela("SELECT * FROM Usuarios");
        // Configuração inicial dos botões e campos
        disposicaoBotoes(1);
    ...
    /**
     * Trata o evento do botão "Salvar".
     *
     * @param evt O evento de clique do botão.
     */
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        // Obtenção de dados dos campos
        ...
        // Se os campos de login e senha estão preenchidos corretamente
        if (jTextFieldLogin.getBackground() == Color.white && jPasswordFieldSenha.getBackground() == Color.white) {
            ...
            if (imagemGeral != null) {
                try {
                    // Converte a imagem para bytes e salva no objeto de usuário
            ...
            // Se a flag for 1, cria um novo usuário, caso contrário, atualiza o usuário existente
            if (flag == 1) {
    ...
    private void jButtonCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCancelarActionPerformed
        ...
        limpaCampos();
        // Configura a disposição dos botões para o modo de visualização
        disposicaoBotoes(1);
        // Define o texto do botão "Novo" como "Novo"
        jButtonNovo.setText("Novo");
    }//GEN-LAST:event_jButtonCancelarActionPerformed

    /**
     * Trata o evento do botão "Novo".
     *
     * @param evt O evento de clique do botão.
     */
    private void jButtonNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNovoActionPerformed
        // Verifica o texto atual do botão "Novo" e ajusta a flag correspondente
        if (jButtonNovo.getText().equals("Novo")) {
            flag = 1;
        } else {
            flag = 2;
        }
        // Configura a disposição dos botões para o modo de edição
        disposicaoBotoes(2);
    ...
    /**
     * Trata o evento do botão "Selecionar Imagem".
     *
     * @param evt O evento de clique do botão.
     */
    private void jButtonSelecionarImagemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelecionarImagemActionPerformed
        // Chama o método para selecionar o caminho da imagem
        caminhoFoto();
    }//GEN-LAST:event_jButtonSelecionarImagemActionPerformed

    /**
     * Trata o evento de clique na tabela de usuários.
     *
    ...
    private void jTableUsuariosMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableUsuariosMouseReleased
        // Atualiza a flag e o texto do botão "Novo"
        flag = 2;
        jButtonNovo.setText("Alterar");

        // Verifica se uma linha está selecionada na tabela de usuários
        if (jTableUsuarios.getSelectedRow() != -1) {
            ...
            // Executa uma consulta SQL para obter os dados completos do usuário
            ...
            try {
                if (conn.rs.next()) {
                    ...
                    // Carrega e exibe a imagem do perfil, se existir
                    if (conn.rs.getBytes("imagemPerfil") != null && conn.rs.getBytes("imagemPerfil").length > 0) {
                        ...
                        // Se não houver imagem, limpa o ícone
    ...
    private void jTextFieldTelefoneActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldTelefoneActionPerformed
        // Obtém o texto do campo de telefone
        String telefone = jTextFieldTelefone.getText();

        // Verifica e corrige o formato do telefone
        if (!telefone.matches("\\(\\d{2}\\) \\d{4}-\\d{4}")) {
            // Corrige o formato do TextField
            ...
            // Atualiza o texto do campo de telefone
    ...
    private void limparCampos() {
        ...
        Collection<JTextField> campos = Arrays.asList(jTextFieldLogin, jPasswordFieldSenha, jTextFieldTelefone, jTextFieldEmail);
    ...
    private void caminhoFoto() {
        ...
        if (escolha == JFileChooser.APPROVE_OPTION) {
            ...
            // Chama o método para lidar com a foto
    ...
    private Image redimensionarImagem(BufferedImage imagemOriginal, int largura, int altura) {
        if (imagemOriginal != null) {
            ...
            // Cria uma imagem intermediária com a resolução desejada
    ...
    /**
     * Atualiza a tabela de usuários com base na consulta SQL fornecida.
     *
     * @param sql Consulta SQL para recuperar dados de usuários.
     */
    public void atualizaTabela(String sql) {
        ...
        try {
            // Preenche a tabela com os dados resultantes da consulta
            while (conn.rs.next()) {
                // Cria um objeto de usuário e define seus atributos
    ...
    /**
     * Configura a disposição dos botões e campos com base na flag passada.
     *
     * @param flag Flag para controle de operações.
     */
    ...
    private void limpaCampos() {
        ...
        // Limpa a senha, o ícone da imagem e a área de texto
    ...
    private boolean validaTelefone(String telefone) {
        // Verifica se o número de telefone tem o comprimento correto
